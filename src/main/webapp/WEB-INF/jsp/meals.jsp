...
<script type="text/javascript" src="webjars/datetimepicker/2.5.4/jquery.datetimepicker.css" defer></script>
                        ...
                        <div class="panel-body">
                            <form id="filter" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control col-sm-3" id="endTime" type="time" name="endTime">
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="detailsForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control" type="text" id="description" name="description" placeholder=<spring:message code="meals.description"/> >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="calories" class="control-label col-xs-3"><spring:message code="meals.calories"/>:</label>
                            <div class="col-xs-9">
                                <input class="form-control" type="number" id="calories" name="calories" placeholder=<spring:message code="meals.calories"/> >
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-offset-3 col-xs-9">
                                ...
                                <button class="btn btn-default btn-sm col-xs-offset-8" data-dismiss="modal">Cancel</button>
